...
- **Add your camera** or choose from existing list, customize available shutter speeds, apertures, focal lengths, lenses (soon)
...
Caveat emptor: I am not a practicing web developer. LLMs were used in the development but it is not vibe-coded.
